                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cart">
                            <section class="content-header">
                                ...
                                <h1>
                                    <a class="w3-btn btn-lg w3-blue w3-border w3-right" href="{{ route('rapi',['id'=> $customer->id]) }}">Go back to sales <span class="w3-badge w3-green">{{ Cart::content()->count() }}</span></a>
                                </h1>
                            ...
                            <table id="example1" class="w3-table w3-bordered w3-striped w3-card-4 w3-hoverable">
                                ...
                                @foreach($products as $pdt)
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <a href="{{ route('rapid', ['id' =>$pdt->id]) }}" class="w3-btn w3-round-large">
