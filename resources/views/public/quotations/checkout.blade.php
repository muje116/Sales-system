...
@section('content')
    ...
    <div class="container-fluid" onload="window.print();">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 ">
                      <section class="content-header no-print">
                          <h1>
                              <a class="btn btn-lg btn-warning" href="{{ route('back') }}">Back</a>
                            </h1>

                      </section>
                <h2 class="page-header">
                    <i class="fa fa-globe"></i> Randera{{-- $company->name --}}.
        ...
        <div class="row w3-card-4">
            <div class="">
                <table class="table table-striped w3-table w3-card-4 w3-hoverable w3-card-4">
                           <thead>
                                <tr class="w3-blue">
                                    <th >Product</th>
                                    <th >Price</th>
