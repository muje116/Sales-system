        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header" style="padding-left:20px">
              <a href="{{ route('home') }}" class="navbar-brand"><b><i class="glyphicon glyphicon-home"></i> <?php/* echo $branch_name;*/?> </b></a>
			...
			*/ ?>
                      ...
                      <li class="footer"><a href="{{ route('inventory') }}">View all</a></li>
                    </ul>
                  </li>
                  <!-- Tasks Menu -->
				   <li class="dropdown notifications-menu">
                  ...
                  <!-- Tasks Menu -->
				   ...
				   <li class="dropdown notifications-menu">
                    ...
                    <a href="{{ route('quotations') }}">
                      <i class="glyphicon glyphicon-list text-green"></i> Quotations
                     ...
                     <li>
					    ...
					    <li><!-- start notification -->
                         ...
                         <a href="income.php">
                          ...
                          <li><!-- start notification -->
                         <a href="{{ route('quotations') }}">
                              <i class="glyphicon glyphicon-usd text-blue"></i>Quotations
                            </a>
                          </li><!-- end notification -->
                        </ul>
                      </li>
