                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="cart-total">
                            <h3 class="cart-total-title"> Local Purchase Order</h3>
                        </div>
                                    ...
                                    <td colspan="5" class="actions">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                ...
                                                <input type="text" name=" org_name" class="email input-standard-grey" id="" value="{{ old('org_name') }}">
                                            </div>
                                            <div class="">
                                                <label for="contact">LPO Number</label>
                                                <input type="text" name="lpo_number" class="email input-standard-grey" id="" value="{{ old('lpo_number') }}">
                                            </div>
                                            <div class="">
                                                <label for="contact">Customer Name</label>
                                                <input type="text" name="cust_name" class="email input-standard-grey" id="" value="{{ old('cust-name') }}">
                                            </div>
